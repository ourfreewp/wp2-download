<?php
/**
 * Releases page wrapper and tab navigation.
 *
...
<div class="wrap wp2-releases">
	<h1><?php echo esc_html__( 'WP2 Releases', 'wp2-download' ); ?></h1>
	<p class="description">
	...
	<?php if ( ! empty( $tabs ) ) : ?>
		...
		<div class="wp2-releases__tab-panel" role="tabpanel"
