<?php
// wp-content/mu-plugins/wp2-download/src/Admin/views/releases/mu-plugins.php
defined( 'ABSPATH' ) || exit();

use WP2\Download\Config as Config;

/**
 * @component_id admin_muplugin_releases_table
 * @namespace admin.views.releases
 * @type Table
 * @note "Table view for MU plugin releases in admin."
 */
class MUPluginReleases extends \WP2\Download\Helpers\PrepareTable {
...
$table = new MUPluginReleases();
use WP2\Download\Helpers\RenderTable;
RenderTable::render( $table, \__( 'MU Plugin Releases', 'wp2-download' ), 'wp2-hub-mu-plugin-releases' );