<?php
/**
 * Audits page wrapper and tab navigation.
 *
...
<div class="wrap wp2-audits">
	<h1><?php echo esc_html__( 'WP2 Audits', 'wp2-download' ); ?></h1>
	<p class="description">
	...
	<?php if ( ! empty( $tabs ) ) : ?>
		...
		<div class="wp2-audits__tab-panel" role="tabpanel"
