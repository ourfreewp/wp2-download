<?php
// wp-content/mu-plugins/wp2-download/src/Admin/views/audits/analytics.php
...
<?php if ( true ) : ?>
	<div class="card p-3">
		...
		<p><strong><?php echo esc_html__( 'Project API:', 'wp2-download' ); ?></strong> <code>https://app.posthog.com</code>
		</p>
		<p><strong><?php echo esc_html__( 'Project API Key:', 'wp2-download' ); ?></strong> <code>phc_xxxx</code></p>
		<hr>
		...
		<div class="table-responsive">
			<table class="widefat striped table-view-list">
				...
				<tbody>
					<tr>
						<td><a href="<?php echo esc_url( 'https://site-a.example.com' ); ?>" target="_blank"
								rel="noopener noreferrer">https://site-a.example.com</a></td>
						<td><?php echo esc_html( '8/16/2025, 10:30:00 AM' ); ?></td>
					</tr>
					<tr>
						<td><a href="<?php echo esc_url( 'https://site-b.example.com' ); ?>" target="_blank"
								rel="noopener noreferrer">https://site-b.example.com</a></td>
		...
		<p><strong><?php echo esc_html__( 'Event:', 'wp2-download' ); ?></strong> <span
				class="badge rounded-pill text-bg-info">$pageview</span></p>
		<p><strong><?php echo esc_html__( 'Timestamp:', 'wp2-download' ); ?></strong>
			<?php echo esc_html( '8/16/2025, 10:30:00 AM' ); ?></p>
