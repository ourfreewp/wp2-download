 ...
 *
 * Minimal Cloudflare R2 adapter with S3-compatible endpoint awareness.
 * Verifies presence of required configuration and offers URL helpers.
 */
class CloudflareR2Adapter implements ConnectionInterface {
