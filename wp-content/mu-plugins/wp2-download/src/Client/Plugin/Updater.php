...
/**
 * Class Updater
 * Handles self-hosted updates for distributed WordPress plugins.
 *
 * @package WP2\Download\Client
 */
namespace WP2\Download\Client\Plugin;

/**
 * Handles self-hosted updates for distributed WordPress plugins.
 *
 * This class should be packaged with any client plugin.
 *
 * @credit Inspired by the work of Misha Rudrastyh and Austin Ginder.
 */
class Updater {
	/**
