...
final class Generator {
	...
	public static function from_components( array $components, array $opts = [] ): string {
		...
		$valid_components = array_filter( $components, [ self::class, 'validate_component' ] );
	...
	private static function build_header( array $opts ): array {
		...
		$class_defs = array_merge( $default_class_defs, $opts['class_defs'] ?? [] );
	...
	private static function get_placeholder_diagram(): string {
		$sample_components = [ 
			'api_gateway' => [ 
				'component_id' => 'api_gateway', 'namespace' => 'Core.Services', 'type' => 'Service', 'title' => 'API Gateway', 'css_class' => 'service',
				'facets' => [ 
					[ 'name' => 'handleRequest', 'visibility' => 'public', 'parameters' => [ [ 'name' => 'req' ] ], 'returnType' => 'Response', 'classifier' => 'abstract' ],
				],
				'relations' => [ 
					[ 'to' => 'license_manager', 'type' => 'dependency', 'label' => 'validates via', 'fromCard' => '1', 'toCard' => '1' ],
				],
				'note' => 'Handles all incoming API requests.',
			],
			'license_manager' => [ 
				'component_id' => 'license_manager', 'namespace' => 'Business.Logic', 'type' => 'Manager', 'title' => 'License Manager', 'css_class' => 'manager',
				'facets' => [ 
					[ 'name' => 'validate', 'visibility' => 'public', 'parameters' => [ [ 'name' => 'key' ] ], 'returnType' => 'bool' ],
				],
			],
		];
		return self::from_components( $sample_components, [ 'comments' => [ 'This is a placeholder diagram.' ] ] );
	}
