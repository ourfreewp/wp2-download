<?php
/**
 * Admin page for architecture visualization.
 **/

namespace WP2\Download\Modules\Archi\Admin;
 ...
 * Admin page for architecture visualization.
 *
 * @component_id archi_admin_page
 * @namespace archi.admin
 * @type Page
 * @note "Admin page for architecture visualization."
 * @facet {"name": "boot", "visibility": "public", "returnType": "void"}
 * @facet {"name": "add_menu_page", "visibility": "public", "returnType": "void"}
 * @facet {"name": "render", "visibility": "public", "returnType": "void"}
...
final class Page
{
    ...
    public function render(): void
    {
		...
		<div class="wrap">
			...
			<textarea style="width:100%;height:320px; font-family: monospace;" readonly><?php echo esc_html($mermaid); ?></textarea>
