<?php
/**
 * Fallback adapter for analytics connections.
 *
 * @package WP2\Download\Core\Analytics\Adapters\Fallback
 */

namespace WP2\Download\Core\Analytics\Adapters\Fallback;
